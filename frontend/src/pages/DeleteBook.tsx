  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        <div className="bg-white text-black text-center p-3 rounded w-[400px] shadow-2xl flex flex-col items-center gap-5">
          <h2>Are you sure you want to delete?</h2>
          <MdDelete
            onClick={() => mutation.mutate(id)}
            className="text-[35px] hover:cursor-pointer text-zinc-700"
          />
        </div>
      </div>
    </>
